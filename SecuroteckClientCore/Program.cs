...
namespace SecuroteckClientCore
{
    ...
    class Client
    {
        ...
        private static async Task UserDelete()
        {
            ...
            var request = new HttpRequestMessage(HttpMethod.Delete,
                ($"{Endpoint}{UserController}RemoveUser?username={UserName}"));
        ...
        private static async Task ProtectedSha1(string text)
        {
            ...
            var request =
                new HttpRequestMessage(HttpMethod.Get, ($"{Endpoint}{ProtectedController}sha1?message={text}"));
            request.Headers.Add(nameof(_apiKey), _apiKey);
        ...
        private static async Task ProtectedSha256(string text)
        {
            ...
            var request =
                new HttpRequestMessage(HttpMethod.Get, ($"{Endpoint}{ProtectedController}sha256?message={text}"));
            request.Headers.Add(nameof(_apiKey), _apiKey);
